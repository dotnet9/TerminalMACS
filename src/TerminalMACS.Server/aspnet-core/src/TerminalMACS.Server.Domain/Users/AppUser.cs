...
namespace TerminalMACS.Server.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update ServerDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update ServerEfCoreEntityExtensionMappings to extend the IdentityUser entity
